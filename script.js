...
Object.assign(window.PIGIAZZA_STRINGS.en, {
    ...
    "hero.headingPost": "made by someone who lives and breathes Minecraft — with the occasional detour.",
    "hero.sub": "New to modding, mostly Minecraft — but not only. I build things I actually want to use, test them properly, then publish them.",
    "hero.ctaProjects": "See what I’ve built",
    "hero.ctaContact": "Say hello",
    "about.statement": "Every project starts the same way: something’s missing, so I build it — usually for Minecraft, sometimes not. Then I make sure it actually holds up before anyone else sees it.",
    ...
    "about.bio2": "No roadmap, no backers, no deadlines but my own. Just whatever’s missing this week — mostly in Minecraft — built until it’s solid enough to hand to strangers on the internet.",
    ...
    "faq.q1": "Is everything you make free?",
...
Object.assign(window.PIGIAZZA_STRINGS.it, {
    ...
    "hero.headingPost": "creati da chi vive Minecraft in prima persona — con qualche deviazione ogni tanto.",
    "hero.sub": "Alle prime armi con le mod, soprattutto per Minecraft — ma non solo. Creo cose che voglio usare io per primo, le testo sul serio, poi le pubblico.",
    "hero.ctaProjects": "Guarda cosa ho creato",
    "hero.ctaContact": "Scrivimi",
    "about.statement": "Ogni progetto nasce allo stesso modo: manca qualcosa, quindi lo creo — di solito per Minecraft, ogni tanto no. Poi mi assicuro che regga davvero prima di farlo vedere a chiunque altro.",
    ...
    "about.bio2": "Nessuna roadmap, nessun finanziatore, nessuna scadenza se non le mie. Solo quello che manca questa settimana — di solito in Minecraft — costruito finché non regge abbastanza da darlo in mano a sconosciuti su internet.",
